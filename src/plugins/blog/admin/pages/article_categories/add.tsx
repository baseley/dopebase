...
import { ClipboardCheck, Loader2, Upload, X } from "lucide-react"
...
import { IMTextAreaComponent, IMPhoto } from "../../../../../admin/components/forms/fields"
                        ...
                        <div style={sc.imagePreview}>
                          ...
                          <div style={sc.imagePreviewOverlay}>
                            <button
                              type="button"
                              onClick={() =>
                                handleDeletePhoto(modifiedNonFormData.logo_url as string, "logo_url", false)
                              }
                              style={{
                    ...
                    >
                      ...
                      <div
                        style={{
                          ...
                          width: "44px",
                          height: "24px",
                          backgroundColor: modifiedNonFormData.published
                        ...
                        onClick={() => handleSwitchChange(!modifiedNonFormData.published, "published")}
                      >
                        <div
                          style={{
                            position: "absolute",
                            top: "2px",
                            left: modifiedNonFormData.published ? "calc(100% - 22px)" : "2px",
                            width: "20px",
                            height: "20px",
